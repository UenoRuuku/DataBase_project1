...
# 初始医院人员
insert_user(cursor, 'doctor1', '111', '万医生', 'doctor')
insert_user(cursor, 'doctor2', '222', '兔医生', 'doctor')
insert_user(cursor, 'doctor3', '333', '岁医生', 'doctor')
insert_user(cursor, 'nurse_master1', '111', '万护士长', 'nurse_master')
insert_user(cursor, 'nurse_master2', '222', '兔护士长', 'nurse_master')
insert_user(cursor, 'nurse_master3', '333', '岁护士长', 'nurse_master')
insert_user(cursor, 'ward_nurse1', '111', '万病房护士', 'ward_nurse')
insert_user(cursor, 'ward_nurse2', '222', '兔病房护士', 'ward_nurse')
insert_user(cursor, 'ward_nurse3', '333', '岁病房护士', 'ward_nurse')
insert_user(cursor, 'em_nurse1', '111', '万护士', 'em_nurse')
insert_user(cursor, 'em_nurse2', '222', '兔护士', 'em_nurse')
insert_user(cursor, 'em_nurse3', '333', '岁护士', 'em_nurse')
db.commit()
